...
def main(args):
  audio_metadata_json = args.metadata
...
if __name__ == '__main__':
  ...
  parser.add_argument("--metadata", type=str, default="eval_audio_metadata.json",
                        help='location of the audio metadata generated by segsep.datasets.generate_audio_metadata')
